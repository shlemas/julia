...
typedef struct _jl_binding_t {
    ...
    _Atomic(jl_globalref_t*) globalref;  // cached GlobalRef for this binding
    _Atomic(struct _jl_binding_t*) owner;  // for individual imported bindings (NULL until 'resolved') -- TODO: make _Atomic
